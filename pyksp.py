...
def _get_apistrings_read(base, vessel):
    ...
    try:
        ...
        print "Exception occurred while loading JSON from " + base + callstring
...
def _run(command):
    ...
    try:
        ...
        print "Exception occurred while opening URL: " + command
...
class ActiveVessel:
    ...
    "vessel_velocity":"v.orbitalVelocity",
    ...
    "toggle_map":"m.toggleMapView",

    "toggle_fbw":"v.setFbW",
    "six_dof":"v.setPitchYawRollXYZ"
    }
    ...
    def test_connection(self):
        """Test a connection to the telemachus server, and return False if it fails"""
        try:
            urllib2.urlopen(self.base+'a=p.paused').read()
        except:
            return False
